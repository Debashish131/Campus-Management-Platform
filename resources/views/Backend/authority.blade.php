...
<head>
    ...
    <meta charset="utf-8"/>
    <title>@yield('title') - {{ config('app.name', 'Authority') }}</title>
    ...
    <!-- Bootstrap Css -->
    <link href="assets2/css/bootstrap-dark.min.css" id="bootstrap-style" rel="stylesheet" type="text/css"/>
    <!-- Icons Css -->
    <link href="assets2/css/icons.min.css" rel="stylesheet" type="text/css"/>
    <!-- App Css-->
    <link href="assets2/css/app-dark.min.css" id="app-style" rel="stylesheet" type="text/css"/>
    @stack('css')
        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="navbar-brand-box text-center">
                    <a href="/authority" class="logo logo-dark">
                                <span class="logo-sm">
                    ...
                    <a href="/authority" class="logo logo-light">
                                <span class="logo-sm">
            ...
            <div class="d-flex">
                ...
                <div class="dropdown d-inline-block user-dropdown">
                    <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img class="rounded-circle header-profile-user" src="storage/authority/{{Auth::user()->image}}"
                             alt="Header Avatar">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <a class="dropdown-item" href="/Authprofilepic"><i class="ri-user-line align-middle me-1"></i>
                            Profile</a>

                        <a class="dropdown-item d-block" href="#"><span
                                class="badge bg-success float-end mt-1">11</span><i
                                class="ri-settings-2-line align-middle me-1"></i> Settings</a>
                        <a class="dropdown-item" href="AuthPass"><i class="ri-lock-unlock-line align-middle me-1"></i>Password
                        </a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item text-danger" href="/authlogout"><i
            ...
            <div id="sidebar-menu">
                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li class="{{ (request()->is('authority')) ? 'active' : '' }}">
                        <a href="/authority"
                           class="waves-effect nav-link {{ request()->is('authority') ? 'active' : '' }}">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="/authComplain">User Complains</a></li>
                            <li><a href="/authSuggestion">User Suggestion</a></li>
                        </ul>
                    </li>
        ...
        <div class="p-4">
            ...
            <div class="form-check form-switch mb-3">
                <input class="form-check-input theme-choice" type="checkbox" id="dark-mode-switch"
                       data-bsStyle="..assets2/css/bootstrap-dark.min.css"
                       data-appStyle="..assets2/css/app-dark.min.css">
