        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
            ...
            <div class="p-3">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <a href="/authComplain" class="small"> View All</a>
                    </div>
                </div>
            </div>
            <div data-simplebar style="max-height: 230px;">
                @foreach($complain->slice(0,3) as $val)
                    <a href="/authComplain" class="text-reset notification-item">
                        <div class="d-flex">
            ...
            <div class="p-2 border-top">
                <div class="d-grid">
                    <a class="btn btn-sm btn-link font-size-14 text-center" href="/authComplain">
