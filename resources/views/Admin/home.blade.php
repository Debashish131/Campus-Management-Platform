            ...
            <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex text-muted">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <p class="mb-1">Notice Updated</p>
                                        <h5 class="mb-3">{{$count = \App\PDF::all()->count()}}</h5>
                                        <p class="text-truncate mb-0"><span class="text-success me-2"> 0.01% <i
                                                    class="ri-arrow-right-up-line align-bottom ms-1"></i></span>Updated</p>
                                    </div>
                                </div>
                            </div>
                            <!-- end card-body -->
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <div id="usa" style="height: 226px">
                                        <iframe
                                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3648.3585721112886!2d90.31797051442014!3d23.87690048985018!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b8ada2664e21%3A0x3c872fd17bc11ddb!2sDaffodil%20International%20University!5e0!3m2!1sen!2sbd!4v1669653408473!5m2!1sen!2sbd"
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Latest Complain Assign</h4>
