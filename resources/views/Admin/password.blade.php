                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Password Change</a></li>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="/passwordChange" method="post" id="myForm"
                                  enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3 row">
                                    <label for="example-old-input" class="col-md-2 col-form-label">Old Password</label>
                                    <div class="col-md-10">
                                ...
                                <div class="mb-3 row">
                                    <label for="example-new-input" class="col-md-2 col-form-label">New Password</label>
                                    <div class="col-md-10">
